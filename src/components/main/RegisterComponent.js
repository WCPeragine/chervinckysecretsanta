...
class RegisterComponent extends React.Component {
  ...
  changeErrorMsg = () => {
    if (
      !this.state.signInPasswordTwo.length &&
  ...
  onRegisterSubmit = () => {
    if (
      this.state.signInPassword === this.state.signInPasswordTwo &&
      this.state.signInPassword.length &&
      this.state.signInPasswordTwo.length
    ) {
      this.setState({ errorMsg: "Attempting To Register" });
      fetch(String(this.state.fetchUrl) + "register", {
        method: "post",
    ...
    return (
      <div>
        ...
        <form className="signInForm">
          <div className="welcomeDiv">{String(errorMsg)}</div>
          <div className="signInInfoDiv">
            ...
            <div className="signInLabelsDiv">
              ...
              <label htmlFor="passwordTwoInput" className="signInLabels">
                Re-Enter:
              </label>
            </div>
